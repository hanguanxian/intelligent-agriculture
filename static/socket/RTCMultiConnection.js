...
window.RTCMultiConnection = function(roomid, forceOptions) {
    ...
    function MultiPeers(connection) {
        ...
        this.getLocalConfig = function(remoteSdp, remoteUserId, userPreferences) {
            ...
            return {
                ...
                onDataChannelMessage: function(message) {
                    ...
                    console.log("connection.fbr"+connection.fbr);
                    ...
                    if (message.readyForNextChunk) {
                        console.log("readyForNextChunk");
                        console.log("connection.peers[remoteUserId].peer.channel"+remoteUserId);
                        console.log(connection.peers[remoteUserId].peer.channel);
        ...
        function initFileBufferReader() {
            console.log("initFileBufferReader1");
            connection.fbr = new FileBufferReader();
            console.log("initFileBufferReader2");
        ...
        this.shareFile = function(file, remoteUserId) {
            ...
            connection.fbr.readAsArrayBuffer(file, function(uuid) {
                ...
                console.log("arrayOfUsers1"+arrayOfUsers);
                console.log("remoteUserId"+remoteUserId);

                if (remoteUserId) {
                    arrayOfUsers = [remoteUserId];
                }
                console.log("arrayOfUsers2"+arrayOfUsers);
    ...
    function PeerInitiator(config) {
        ...
        function setChannelEvents(channel) {
            ...
            channel.send = function(data) {
                console.log("data channel send1");
                if (channel.readyState !== 'open') {
                    return;
                }
                console.log("data channel send2");
